if !file_exists("lang/en_US.lang") {
    ini_open("lang/en_US.lang")
        ini_write_string("Menu - Main", "play_text", "PLAY")
        ini_write_string("Menu - Main", "settings_text", "SETTINGS")
        ini_write_string("Menu - Main","exit_text","EXIT")
